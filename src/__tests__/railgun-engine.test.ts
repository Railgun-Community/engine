...
const generateAndVerifyPOI = async (
  ...
  try {
    ...
    // expect(await wallet.getTXOsReceivedPOIStatusInfo(chain)).to.deep.equal({});
      ...
      await generateAndVerifyPOI(
        ...
        transactions,
        {
          anyRailgunTxidMerklerootAfterTransaction:
            '1034c2f85fd1baa11e145c83d0c83eb257692c8c01201eb6d8c41b16d7d46767',
        ...
        [
          '0x122ed05a22dfc08d5c16ea4a8ae4b39abba8439f5b63ff028a4cb3059af2eb72',
          '0x0d91cf234a3a08ae48caec2fe6619a974710716b6555593169118e2b46596688',
          '0x13d7f17612f16979c92ddaba1f086f1ac1c71dafdd7734943030b4ef42f39310',
        ],
      );
