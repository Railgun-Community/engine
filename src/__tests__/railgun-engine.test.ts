    ...
    await generateAndVerifyPOI(
      ...
      provedTransactions,
      {
        anyRailgunTxidMerklerootAfterTransaction: isV2Test()
          ...
          : '028911a903cb91f80d41b7b35eece2ad97d852e8123a45301abf856be9a9360a', // Different boundParamsHash for V3 changes the railgun txid
        boundParamsHash: isV2Test()
          ? '0357cc6d8af845f638fb6e2bdbf482f466d11454a2e31c69d9b7ec69ce8cd873'
          : '2a6a911934b3c344f50b147258142d216c4faec965704b99a7f0d9694733bb10', // Different boundParamsHash for V3 changes the railgun txid
        commitmentsOut: [
        ...
        railgunTxidIfHasUnshield: isV2Test()
          ...
          : '0x052733be003d3432ce19721d70aadc854fac8c9811f3219c09e67d92c28636a7', // Different boundParamsHash for V3 changes the railgun txid
      ...
      await generateAndVerifyPOI(
        ...
        provedTransactions,
        {
          anyRailgunTxidMerklerootAfterTransaction: isV2Test()
            ...
            : '1e932177efa58f7250d2898389d3e434e66658bb497a077d0b21e86e846ffd8e', // Different boundParamsHash for V3 changes the railgun txid
          boundParamsHash: isV2Test()
            ? '0a4e7bed8287c629fd064665543dc71fdc09b0ab9df7d556f24a1f2f9f018dc7'
            : '11779f11504cf7f4badbfafbe7b99a2f5d6444c2f657edc845e2339233d4442c', // Different boundParamsHash for V3
          ...
          railgunTxidIfHasUnshield: isV2Test()
            ...
            : '0x2c570a7c0a8ed2bdb085f6e9a7e013d0fd9d25587cd4f0c81d329a761f25efca', // Different boundParamsHash for V3 changes the railgun txid
          valuesIn: [109725000000000000000000n],
          valuesOut: [],
