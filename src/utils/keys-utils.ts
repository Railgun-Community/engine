...
async function getEphemeralKeys(senderVPK: Uint8Array, recipientVPK: Uint8Array): Promise<Uint8Array[]> {
...
async function getSharedSymmetricKey(privateKey: Uint8Array, publicKey: Uint8Array): Promise<Uint8Array> {
