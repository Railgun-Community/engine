...
export declare namespace Staking {
  ...
  export type GlobalsSnapshotStructOutput = [BigNumber, BigNumber, BigNumber] & {
    interval: BigNumber;
...
export interface StakingStubInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'snapshotStub', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: 'stake', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
    functionFragment: 'stakes',
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>],
  ): string;
  encodeFunctionData(functionFragment: 'stakesLength', values: [PromiseOrValue<string>]): string;
  ...
  decodeFunctionResult(functionFragment: 'snapshotStub', data: BytesLike): Result;
...
export interface StakingStub extends BaseContract {
  ...
  functions: {
    ...
    stakesLength(_account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    votingPower(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  callStatic: {
    ...
    claim(_stakeID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    snapshotStub(_account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    stake(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    undelegate(_stakeID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    unlock(_stakeID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
