...
export interface GovernanceTargetNumberStubInterface extends utils.Interface {
  functions: {
    'a()': FunctionFragment;
...
export interface GovernanceTargetNumberStub extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTargetNumberStubInterface;
