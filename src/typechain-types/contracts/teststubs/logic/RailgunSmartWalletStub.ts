...
export interface RailgunSmartWalletStubInterface extends utils.Interface {
  functions: {
    ...
    "transact((((uint256,uint256),(uint256[2],uint256[2]),(uint256,uint256)),bytes32,bytes32[],bytes32[],(uint16,uint72,uint8,uint64,address,bytes32,(bytes32[4],bytes32,bytes32,bytes,bytes)[]),(bytes32,(uint8,address,uint256),uint120))[])": FunctionFragment;
  ...
  events: {
    ...
    "Nullifiers(uint256,bytes32[])": EventFragment;
...
export type NullifiersEvent = TypedEvent<
  [BigNumber, string[]],
...
export interface RailgunSmartWalletStub extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RailgunSmartWalletStubInterface;
  ...
  callStatic: {
    ...
    newTreeStub(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "Nullifiers(uint256,bytes32[])"(
      treeNumber?: null,
      nullifier?: null
    ): NullifiersEventFilter;
