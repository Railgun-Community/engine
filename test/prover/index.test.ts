...
const testVector: ERC20Inputs = {
  ...
  pathIndices: ['00', '01'],
  recipientPK: [
    '17c56cf028b0bec412eece0ef70ca2423638b1c21e1bd3a3a78cce9a9dbba1c6',
    '13d447f1f8d70b28d85c681aaa3a5f6e9d64c075db20f0611f4d6b016204252c',
    '304a98f1fe7d8bf92257b7536dcfe749cdda2b094879c3eb39fe7485057583e7',
    '01aeb7b995da92fd4448bc2254b6a80e64acd45279126c64a95c4a8b08d6123e',
    '0437475e917458be45bb44f401af0d501f8f72a683e928ec645f0cfb19429ded',
    '10c1e469316a0f450211f0b8ed2792b14f22facd3f93f0cedb5c54270fea8f51',
  ],
  randomOut: [
...
describe('Prover/Index', () => {
  ...
  it('Should calculate inputs hash correctly', async () => {
    expect(Prover.hashInputs(testVector)).to.equal('2d0eaa4d90dd738bf8a7232f4c1be0634f4f38a06bb3c17bd07d7f5c35e00601');
  });
});
